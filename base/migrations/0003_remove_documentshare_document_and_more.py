    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owned_lists', to='base.customer')),
            ],
        ),
        migrations.CreateModel(
            name='GroupList',
            fields=[
                ...
                ('permission_type', models.CharField(choices=[('read_only', 'Read-Only'), ('full_access', 'Full Access')], default='read_only', max_length=20)),
